...
async function Default() {
  ...
  const formattedTime = `${String(hours % 12).padStart(2, "0")}:${String(
    minutes
  ...
  const formatteTime = `${String(hour % 12).padStart(2, "0")}:${String(
    minute
 ...
 const formattedTime = `${String(hours % 12).padStart(2, "0")}:${String(
  ...
  const formatteTime = `${String(hour % 12).padStart(2, "0")}:${String(
	  ...
	  if (data.temp > 25) {
		  ...
		  weather_description.innerHTML = "-----";
		  weather_images.src = "/images/location Error.png";
		  weather_images.style.height = "210px";
		  temperature.innerHTML = ` <sup>0°C</sup>`;
		  wind_details.innerHTML = `<span >--km/h</span>`;
		  humidity_details.innerHTML = `<span >--%</span>`;
		  ...
		  City.innerHTML = "Please Enter Location";
